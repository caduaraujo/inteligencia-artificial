...
while True:
    ...
    if bird.rect[1] > 600:
        print('passaro chao')
        pygame.time.set_timer(KEYDOWN, 5)

    elif pipes[0].rect[1] > bird.rect[1]+50:
        print('cano menor que passaro')
        # print(bird.rect[1])
        # print('-------- MEIO')
        # print('-------- MEIO')
        # print(pipes[0].rect[1])
        pygame.time.set_timer(KEYDOWN, 51)
    else:
        print('cano maior que passaro')
        pygame.time.set_timer(KEYDOWN, 20)
